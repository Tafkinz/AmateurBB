...
namespace WebApp.Controllers
{
    public class ContactTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ContactTypeId,ContactTypeName")] ContactType contactType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("ContactTypeId,ContactTypeName")] ContactType contactType)
        {
